...
This project focuses on testing different **reactive navigation algorithms** for a mobile robot **without velocity control mechanisms** like PID or Pure Pursuit. The goal is to evaluate how the robot reacts to **different track conditions** using only **LiDAR data** for control.
